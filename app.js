...
//app.use('/users', users);
app.use('/mean', mean1);
app.use('/tunisianetPC',isAuthenticated, tunisianetPC);
app.use('/mytekPC',isAuthenticated, mytekPC);
...
app.use('/news',isAuthenticated, require('./routes/medianews'));
app.use('/radio',isAuthenticated, require('./routes/radio'));
app.use('/map',isAuthenticated, require('./routes/map'));
app.use('/sms',isAuthenticated, require('./routes/sms'));
app.use('/needs',isAuthenticated, require('./routes/needs'));
app.use('/programs',isAuthenticated, require('./routes/programs'));
app.use('/calendar',isAuthenticated, require('./routes/calendar'));
app.use('/auth', require('./routes/test'));
app.use('/foods',isAuthenticated, food);
app.use('/todo',isAuthenticated, todo);
app.use('/chat',isAuthenticated, require('./routes/chat')(io));
app.use('/schedule',isAuthenticated, require('./routes/scheduale'));
app.use('/pcs',isAuthenticated, pcs);
app.use('/tablettes',isAuthenticated, tablettes);
app.use('/tvs',isAuthenticated, tvs);
app.use('/imprimantes',isAuthenticated, imprimantes);
app.use('/league', isAuthenticated,require('./routes/league'));
